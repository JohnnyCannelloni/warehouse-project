...
compile: bin/Action.o bin/Customer.o bin/Order.o bin/Parse.o bin/Volunteer.o bin/WareHouse.o bin/main.o
...
bin/Parse.o: src/Parse.cpp
	g++ -g -Wall -Weffc++ -std=c++11 -c -Iinclude src/Parse.cpp -o bin/Parse.o
...
bin/warehouse: bin/Action.o bin/Customer.o bin/Order.o bin/Parse.o bin/Volunteer.o bin/WareHouse.o bin/main.o
...
run: 
	./bin/warehouse bin/rest/input_file.txt