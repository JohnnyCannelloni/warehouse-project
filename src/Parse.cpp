...
void Parse::parseConfigFile(const std::string& configFilePath) {
...
void Parse::parseCustomerLine(const std::string& line) {
    std::istringstream iss(line);
...
void Parse::parseVolunteerLine(const std::string& line) {
    std::istringstream iss(line);
...
std::vector<Customer*>& Parse::getCustomers() {
    return customers;
}

std::vector<Volunteer*>& Parse::getVolunteers() {
    return volunteers;
}
